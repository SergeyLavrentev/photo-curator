...
4. Regular albums выбираются, Shared Albums disabled.
5. Inventory, previews, metrics, groups и decisions работают.
...
11. Capability-gated publish создаёт новый regular Reject album.
