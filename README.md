...
сервисом группы дублей и текущий Top-K намеренно не превращаются в human ground truth;
недостающие series/leader/Top-K labels нужно заполнить человеком до evaluation.
